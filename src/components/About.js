...
const About = () => {
    let ACCOUNTS = require("../images/bg1.jpg");
    let TRAVEL = require("../images/bg1.jpg");
    let TYPEWRITER = require("../images/bg1.jpg");
    let LOANS = require("../images/bg1.jpg");

    return ( 
        <div className="about h-full">
            <Navbar/>
            
            <div className="header text-white px-6 lg:px-24 py-10 bg-[url('./images/bg1.jpg')] bg-opacity-50 bg-no-repeat bg-center bg-cover space-y-2">
                <h1 className="text-3xl lg:text-4xl"><b>About VOLUNTEER ENERGY</b></h1>
                <p className="text-xl lg:max-w-xl">Volunteer Energy was Established in 2000 with a license of an European broker regulated by the 
